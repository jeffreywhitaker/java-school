...
public interface CourseRepository extends PagingAndSortingRepository<Course, Long>
{
    ...
    @Query(value = "SELECT s.courseid, coursename, count(studid) as countstudentszzz FROM studcourses s INNER JOIN course c on s.courseid=c.courseid GROUP BY s.courseid, coursename", nativeQuery = true)
